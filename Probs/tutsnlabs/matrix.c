...
//1. Read the following code make sure you understand it. This the initialization
// of the DP table for cost.
int **initMat( int n){
int i,j;
int **X;
...
//b. S[i,j] will contain the index of the last multiplicaion in the subproblem
// A[i..j]
// Checks: Our script will check if you have set the correct values of M[i,j] and
// S[i,j]
